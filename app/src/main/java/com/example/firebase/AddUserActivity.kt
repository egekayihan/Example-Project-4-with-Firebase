...
class AddUserActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //register Activity Result Launcher in onCreate
    ...
    fun addUserToDatabase(url : String, imageName : String){
        ...
        myReference.child(id).setValue(user).addOnCompleteListener { task ->
            ...
            if(task.isSuccessful) {
                Toast.makeText(applicationContext, "New User Added to Database", Toast.LENGTH_LONG)
                    .show()
    ...
    fun uploadPhoto(){
        ...
        imageUri?.let { uri -> imageReference.putFile(uri).addOnSuccessListener {
